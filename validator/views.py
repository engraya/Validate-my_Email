...
def validatePage(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'validator/validatePage.html', context)
    ...
    return render(request, 'validator/validatePage.html')


def homePage(request):
    return render(request, 'validator/homePage.html')
